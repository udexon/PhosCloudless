...
The scenarios described in the previous section have been the de facto practices, as there has been no novel approach proposed to make the division of labor of programming more effective.

- What if we can make the division of labor of programming more efficient?

- Is it possible to create a universal caller script to make the division of labour in programming more effective? 
...
#### Karl Marx's Class Struggle for Proletariat Programmers
...
Karl Marx at the end -- single thread leading discussion to deeper levels. Leave Additional perspective at the end, to elaborate.
